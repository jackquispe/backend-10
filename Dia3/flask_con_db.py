...
app = Flask(__name__)
# cuando tenemos un diccionario poder OBTENER el valor de una de sus llaves con el metodo
# get.('LLAVE'), solo es para obtener, no para asignar.
# Y si que al obtener no hay valor entonces colocara None(vacio)
...
# inicializamos la conexion seteando todos los parametros de nuestra bd, pero aun
...
def gestion_productos():
    if request.method == 'GET':
        ...
        # indicamos que el guardado se permanente en la base de datos
...
# como si fueran variables del entorno
# el .env solo se guardaran variables credenciales.
app.run(debug=True)