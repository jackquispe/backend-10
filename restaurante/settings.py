...
SECRET_KEY = 'django-insecure-nkyf@n3x+b6dxz=fsny7c@045g+z3es3xs+^ig*$phq$n%mtw^'
...
SIMPLE_JWT = {
    'ACCES_TOKEN_LIFETIME': timedelta(hours=1, minutes=10, seconds=5)
}